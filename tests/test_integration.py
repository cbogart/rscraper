...
class RscraperTesting(rscraperTesting.RscraperTesting):
    ...
    def helper_test_metadataPopulate_cran(self, useInternet = False):
        ...
        self.oneDbResultEqual(conn, "select group_concat(repository) from packages;", "cran,cran,cran,cran,cran,cran,cran,cran")
        ...
        #checkCite("testthat", "scopus_citedby_count", "1")
        checkCite("metafor", "scopus_id", "77958110812")
        #checkCite("metafor", "scopus_citedby_count", "498")
        checkCite("zoo", "scopus_id", "21244459873")
        #checkCite("zoo", "scopus_citedby_count", "41")
    ...
    def helper_test_metadataPopulate_bioconductor(self, useInternet = False):
        ...
        self.assertEqual(self.oneDbResult(conn, "select title from citations where package_name='XDE';"),
